...
public final class FlopHorizontalImageProcessor extends AbstractImageMagickProcessor {
    public FlopHorizontalImageProcessor() {
        super(processor("im-flop-horizontal", "ImageMagick flop horizontal", "Flips image horizontally."));
    }

    @Override
    BufferedImage apply(BufferedImage input, ExtensionParameters parameters, ImageProcessingContext context) {
        return ImageMagickLikeOps.flopHorizontal(input);
    }
}
