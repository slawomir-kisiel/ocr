...
public final class SharpenImageProcessor extends AbstractImageMagickProcessor {
    public SharpenImageProcessor() {
        super(processor(
            "im-sharpen",
            "ImageMagick sharpen",
            "Sharpens image edges using convolution."
        ));
    }

    @Override
    BufferedImage apply(BufferedImage input, ExtensionParameters parameters, ImageProcessingContext context) {
        return ImageMagickLikeOps.sharpen(input);
    }
}
