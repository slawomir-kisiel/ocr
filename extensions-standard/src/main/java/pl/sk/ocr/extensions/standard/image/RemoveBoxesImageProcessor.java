...
public final class RemoveBoxesImageProcessor extends AbstractImageProcessor {
    @Override
    public ExtensionDescriptor descriptor() {
        return extensionDescriptor("remove-boxes", ExtensionType.IMAGE_PROCESSOR, "Remove Boxes", "Standard placeholder for removing table/box lines.");
    }
